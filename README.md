...
## Аннотация
Рассматривается задача формирования нелинейной математической модели движения беспилотного летательного аппарата (БПЛА) самолетного типа с учетом контура стабилизации, необходимой для синтеза системы автоматического управления траекторным движением, в условиях отсутствия необходимых данных для ее получения таких как аэродинамических, инерционных характеристик БПЛА, данных о двигательной установке. Предлагается подход, основанный на аппроксимации динамики БПЛА по полетным данным с использованием сети LSTM - типа рекуррентной нейронной сети, способной учитывать долгосрочные зависимости в последовательных данных и временных рядах. Работа направлена на обеспечение устойчивости и качества траекторного управления в условиях неполноты исходных данных.
## Ключевые слова
