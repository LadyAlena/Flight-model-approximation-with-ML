...
## Аннотация
Рассматривается задача формирования нелинейной математической модели движения беспилотного летательного аппарата (БПЛА) самолетного типа, необходимой для синтеза системы автоматического управления траекторным движением, в условиях отсутствия необходимых данных для ее получения, таких как аэродинамических, инерционных характеристик БПЛА, данных о двигательной установке. Предлагается подход, основанный на аппроксимации динамики БПЛА по полетным данным с использованием типа рекуррентной нейронной сети LSTM.
## Ключевые слова
